...
Посмотрим на flame graph функции поиска `HashMap::find()`:
...
используем это. Напишем версию этой функции на Intel intrinsics:
```cpp
...
из соображений совместимости прототипа с предыдущими. В дальнейшем будет
